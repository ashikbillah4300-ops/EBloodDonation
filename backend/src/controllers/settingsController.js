...
const DEFAULT_SETTINGS = [
  ...
  { setting_key: 'donation_number', setting_value: process.env.DEFAULT_DONATION_NUMBER || 'WALLET-01969114300', description: 'Payment Wallet Account' },
  { setting_key: 'deposit_method', setting_value: 'Wallet', description: 'Selected Deposit/Payment Gateway (Wallet)' },
  { setting_key: 'deposit_number', setting_value: process.env.DEFAULT_DONATION_NUMBER || 'WALLET-01969114300', description: 'Active Wallet Number' },
  { setting_key: 'wallet_info', setting_value: 'EBlood Community Wallet', description: 'Wallet instructions and info' },
  { setting_key: 'contact_number', setting_value: process.env.DEFAULT_CONTACT_NUMBER || '+8801969114300', description: 'Public contact phone' },
  { setting_key: 'support_number', setting_value: process.env.DEFAULT_SUPPORT_NUMBER || '+8801969114300', description: 'Support helpline' },
  ...
  { setting_key: 'website_helpline', setting_value: process.env.DEFAULT_CONTACT_NUMBER || '+8801969114300', description: 'Website support hotline number' },
  { setting_key: 'website_support_email', setting_value: process.env.DEFAULT_SUPPORT_EMAIL || 'support@eblood.org', description: 'Website support email address' },
